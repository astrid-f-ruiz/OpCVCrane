...
def build_hsv_range_from_patch(hsv_patch, hue_pad=30, sat_pad=60, val_pad=60):
...
def collect_tape_length_stats(video_path, roi_xywh, frame_indices, hsv_cfg, tracking_defaults):
    ...
    for idx in frame_indices:
        ...
        mask = clean_mask(
            mask_raw,
            open_kernel=int(tracking_defaults.get("morph_open_kernel", 1)),
            close_kernel=int(tracking_defaults.get("morph_close_kernel", 5)),
...
def main():
    ...
    "savgol_window": 10,
    "savgol_polyorder": 3,
    "speed_post_smoothing_window": 20,
