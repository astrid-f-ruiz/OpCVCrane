...
def main():
    ...
    if use_manual_position_window_adjustment and not no_motion_detected:
        move_start_position_s = move_start_position_s + (0.02 * move_start_position_s)
        move_end_position_s = move_end_position_s - (0.05 * move_end_position_s)
    ...
    velocity_info = compute_motion_velocity_metrics(
        ...
        move_start_s=move_start_theta_s,
        move_end_s=move_end_theta_s
    )
